...
public class MedianTest extends TestCase {
	public void testEvaluate() throws EvaluationException, ParameterException {
		...
		assertEquals(new BigDecimal(5), median.childEvaluate(null, null,
				createArgs(new BigDecimal(10), new BigDecimal(2), new BigDecimal(3), new BigDecimal(5), new BigDecimal(-100), new BigDecimal(7), new BigDecimal(100))));
	}
