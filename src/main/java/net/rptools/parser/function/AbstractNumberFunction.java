...
public abstract class AbstractNumberFunction extends AbstractFunction {
    ...
    public void checkParameters(List<Object> parameters) throws ParameterException {
        ...
        for (Object param : parameters) {
            if (!(param instanceof BigDecimal)) throw new ParameterException(String.format("Illegal argument type %s, expecting %s", param == null ? "null" : param.getClass().getName(), BigDecimal.class.getName()));
        }
    }
