	...
	public void checkParameters(List<Object> parameters) throws ParameterException {
		...
		for (Object param : parameters) {
			if (!(param instanceof BigDecimal || param instanceof String))
				throw new ParameterException(String.format("Illegal argument type %s, expecting %s or %s", param.getClass().getName(), BigDecimal.class.getName(), String.class.getName()));
